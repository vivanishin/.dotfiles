...
import socket
from qutebrowser.config import config as qute_config
...
## viewer.
## Type: Bool
# c.content.pdfjs = False # True? -- available only with the other engine..
...
## Type: Int
c.downloads.remove_finished = 1000 * 60 * 1
...
c.hints.chars = 'ghfjdkruvncmeiwoslaqp'

## Dictionary file to be used by the word hints.
## Type: File
# c.hints.dictionary = '/usr/share/dict/words'
# This feature is strange, I like the vimperator's way better.
...
## dialog.
## Type: Int
# what bad does setting this to zero do?
# c.keyhint.delay = 500
...
def update_proxy_statusbar():
    c.statusbar.widgets = statusbar_widgets + [
        f'text:[{c.content.proxy}] ',
    ]

def proxy_changed(option):
    if option == 'content.proxy':
        update_proxy_statusbar()

update_proxy_statusbar()
qute_config.instance.changed.connect(proxy_changed)
...
# C-k somehow works out of the box; TODO: C-u
